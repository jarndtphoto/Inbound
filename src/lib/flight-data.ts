...
export type FlightTimes = { scheduled: number | null; estimated: number | null; actual: number | null; };
export type NormalizedFlight = {
  provider: FlightProvider; flightId: string | null; callsign: string | null; status: string | null; position: NormalizedPosition | null;
  ...
  push: FlightTimes; takeoff: FlightTimes; landing: FlightTimes; gateIn: FlightTimes;
  registration: string | null; type: string | null; hex: string | null; route: string | null;
  ...
  providerEta: number | null; runway: { takeoff: string | null; landing: string | null };
};
